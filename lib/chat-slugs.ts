 ...
 *
 * Blog slugs are auto-generated by `npm run ingest` — see lib/generated-blog-slugs.ts.
 */
import { BLOG_SLUGS } from "@/lib/generated-blog-slugs";
...
export const VALID_BLOG_SLUGS: Set<string> = new Set(BLOG_SLUGS);
...
export function getValidHref(slug?: string): string | null {
  ...
  if (VALID_BLOG_SLUGS.has(slug)) return `/blog/${slug}`;
