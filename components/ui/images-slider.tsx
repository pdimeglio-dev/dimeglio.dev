  ...
  return (
    ...
    >
      ...
      {areImagesLoaded && images.length > 1 && (
        <div className="absolute bottom-4 left-0 right-0 z-50 flex items-center justify-center gap-2">
          <button
            onClick={handlePrevious}
            className="rounded-full bg-black/50 p-1.5 text-white/70 backdrop-blur-sm transition-colors hover:bg-black/70 hover:text-white"
